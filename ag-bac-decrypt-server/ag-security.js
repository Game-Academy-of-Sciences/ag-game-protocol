        ...
        try {
            ...
            switch(type) {
                ...
                case 1:
                    ...
                    // pass
                    var tempData = Buffer.from(new Uint8Array(decryptResult).buffer).toString('base64');
                    
                    var log = String.fromCharCode.apply(null, Buffer.from(tempData, 'base64'));
                    console.log(log);
                ...
                case 2:
                    ...
                    return {
                        ...
                        socketData: Buffer.from(new Uint8Array(m.slice(0, 16)).buffer).toString('base64')
                    };
                case 3:
                    // pass
                    return {
